          ...
          <div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="k-kuva" src="kuvat/pesu1.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/pesu2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/pesu3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/pesu4.jpg" alt="Fourth slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/pesu5.jpg" alt="Fifth slide">
              </div>
      ...
      <div class="row align-items-center content">
        <div class="col-md-6 order-2 order-md-1">
          ...
          <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="k-kuva" src="kuvat/keittiö1.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/keittiö2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/keittiö3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/keittiö4.jpg" alt="Fourth slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/keittiö5.jpg" alt="Fifth slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/keittiö6.jpg" alt="Fifth slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/keittiö7.jpg" alt="Fifth slide">
              </div>
      ...
      <div class="row align-items-center content">
        <div class="col-md-6 order-2 order-md-1">
          <div id="carouselExampleControls3" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="k-kuva" src="kuvat/muut1.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/muut2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/muut3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/muut4.jpg" alt="Fourth slide">
              </div>
              <div class="carousel-item">
                <img class="k-kuva" src="kuvat/muut5.jpg" alt="Fifth slide">
              </div>
